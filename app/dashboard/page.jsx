...
export default function Page() {
  ...
  // If email is not verified, display a prompt to type "verify email" before continuing.
  if (needsVerification) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-100 p-8">
        ...
        <p className="mb-4">Please type "verify email" to continue.</p>
        <input
          type="text"
        ...
        <button
          onClick={() => {
            if (verificationInput.trim().toLowerCase() === "verify email") {
