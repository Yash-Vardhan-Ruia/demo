...
export function SpreadsheetComponent({ pageId = "default" }) {
  ...
  const saveSpreadsheet = async () => {
    const payload = { id: pageId, name: sheetName, data, colWidths, rowHeights };
    const { error } = await supabase.from("api.spreadsheets").upsert(payload); // Changed to "api.spreadsheets"
    if (error) console.error("Save spreadsheet error:", error);
    else alert("Spreadsheet saved!");
  };
