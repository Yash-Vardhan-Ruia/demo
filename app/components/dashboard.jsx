...
export function Dashboard() {
  ...
  const handleViewAllTasks = () => alert("View All Tasks clicked!");
  const handleViewMonthlyCalendar = () => alert("View Monthly Calendar clicked!");
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <header className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="flex items-center gap-2" onClick={() => alert("Create new page from Dashboard clicked!")}>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="shadow-sm hover:shadow-md transition border-none bg-white">
          ...
          <CardContent>
            ...
            <Button className="mt-2 w-full justify-center" onClick={handleAddNote}>
        ...
        <Card className="shadow-sm hover:shadow-md transition border-none bg-white">
          ...
          <CardContent>
            <p className="text-gray-600 text-sm mb-3">
              Manage your tasks and track your to-dos efficiently.
            </p>
            <div className="text-center text-gray-400 py-4">No tasks currently.</div>
            <Button variant="secondary" className="mt-2 w-full justify-center" onClick={handleViewAllTasks}>
        ...
        <Card className="shadow-sm hover:shadow-md transition border-none bg-white">
          ...
          <CardContent>
            ...
            <Button variant="secondary" className="mt-2 w-full justify-center" onClick={handleViewMonthlyCalendar}>
